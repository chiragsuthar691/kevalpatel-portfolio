    ...
    <>
      <nav className="header fixed top-0 backdrop-blur-sm z-50">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
          ...
          >
            <ul className="nav-links flex flex-col p-4 dark:bg-transparent bg-transparent sm:dark:bg-transparent sm:bg-transparent dark:text-slate-50 md:p-0 mt-4 font-medium border rounded-lg md:space-x-8 md:flex-row md:mt-0 md:border-0">
              <li>
                <Link
                  href="#aboutme"
